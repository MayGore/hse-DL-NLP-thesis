...
Вдохновившись этими исследованиями, мы решили посмотреть на ethnical bias и educational bias у LLM в контексте L2 носителей русского языка. Мы сделали фокус на оценке качества / приемлемости текста – мы проверили, есть ли у модели bias к юзеру в зависимости от его этничности и уровня образования. Подробный ход исследования см. в файле "Отчет"
